...
def detect_Signs(frame,frame_draw):
    ...
    if not model_loaded:
        ...
        # 1. Load CNN model
        global model
        model = load_model(os.path.join(os.getcwd(),"/home/jinmin/auto_ws/src/self_driving_car_pkg/self_driving_car_pkg/data/1126_epoch_80_new_saved_model_Ros2_5_Sign.h5"),compile=False)
